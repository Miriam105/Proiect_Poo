...
public class ProiectPOO {
    ...
    public static void main(String[] args) {
        ...
        for (int i=0; i<10; i++) {
            aspiratoareUmede[i] = new AspiratorUmed(10+i, "detergent", 60+i, "jet continuu", "galben", "baterii", "manual", (byte)(2+i), "curatare", "geam");
        }
        ...
        for (int i=0; i<10; i++) {
            aspiratoareUscate[i] = new AspiratorUscat(2, 3+i, 3+i, "albastru", "plastic", "baterii", "semi-automat", (byte)(3+i), "curatare", "pardoseala");
        }
